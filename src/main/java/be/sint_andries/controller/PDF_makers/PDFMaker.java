...
public class PDFMaker {
    ...
    public static void makeTafelverdelingPDF(List<Klant> klanten, String path) throws FileNotFoundException, DocumentException {
        ...
        addTableToDoc(document, stringListHashMap_middag);
        ...
        addTableToDoc(document, stringListHashMap_avond);
    ...
    private static void addTableToDoc(Document document, HashMap<String, List<Klant>> stringListHashMap) throws DocumentException {
